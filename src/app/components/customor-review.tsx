  ...
  return (
    <section className="text-gray-600 body-font">
      <div className="container px-4 py-14 mx-auto">
        ...
        <div className="flex flex-wrap -m-4 gap-4 px-4 justify-center items-center">
            ...
            <div className="px-5 py-5 text-center">
              <a href="#">
                ...
                &quot;Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Facilis quo, dolorem officia sequi eum laboriosam quas
                  perspiciatis laborum impedit sit, maxime natus ratione, nam
                  repellendus! Cupiditate aspernatur facere dolores obcaecati?&quot;
                </p>
              </a>
            </div>
          </div>
